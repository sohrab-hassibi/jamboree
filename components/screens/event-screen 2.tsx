...
export default function EventScreen({
  ...
  const { participationStatus, isLoading, handleGoing, handleMaybe } =
  ...
  const event = {
    ...
    messages: [
      ...
      },
      {
        id: 3,
        sender: "Sophie",
        text: "Friday works for me! What time would be good?",
  ...
  const navigateToProfile = (name: string) => {
    ...
    console.log(`Would navigate to ${name}'s profile`);
    // If you have a profile screen, you can use router.push(`/profile/${name}`)
  };
      ...
      {activeView === "chat" ? (
              ...
              {event.messages.map((message) => (
                <div
                  ...
                  className={`flex items-start ${
                    message.isUser ? "justify-end gap-2" : "gap-2"
                  }`}
                >
                  {!message.isUser && (
                  ...
                  <div>
                    ...
                    <div
                      className={`${
                        message.isUser ? "bg-[#ffd2b0]" : "bg-gray-100"
                      } rounded-lg p-2 mt-1 max-w-xs`}
                    >
                ...
                <div className="p-4 border-b">
                  ...
                  <div className="flex flex-col gap-2 mb-4">
                    ...
                    {(participationStatus === "going" ||
                      ...
                      >
                        Change to{" "}
                        {participationStatus === "going" ? "Maybe" : "Going"}
                      </Button>
                    )}
                  </div>
        ...
        <>
              ...
              <div className="mb-8">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="text-base text-[#ffac6d]">
                    {event.participants.going.length} Going ·{" "}
                    {event.participants.maybe.length} Maybe
                  </div>
                </div>
          ...
          <div className="p-4 border-t flex gap-2">
            <Button className="flex-1 bg-[#ffac6d] hover:bg-[#fdc193] text-black">
              I'm Going
            </Button>
